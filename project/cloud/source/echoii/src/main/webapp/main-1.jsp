	...
	<div class="container-fluid">
		<div class="row-fluid">
			...
			<div id="main-content" class="span9">
				<div class="row">
					<span id="mian-tab-link" class="span4"> <a
						id="main-tab-link-return" href="#"></a> <a id="main-tab-link-show"
						href="#"></a>
					</span>
				...
				<div id="main-btn-toolbar" class="span12">
					<div class="row">
						<div class="btn-toolbar span6">
							...
							</a> <input id="main-uploadfile" class="main_uploadfile"
								style="display: none;" type="file" name="fileselect[]" multiple />
							<a id="main-btn-upload" type="file" class="btn"
								...
								class="icon-arrow-up" multiple></i>上传 </a> <a id="main-btn-plus"
								type="submit" class="btn" href="#main-btn-plus-Modal"
								data-toggle="modal" aria-labelledby="main-btn-plus-Label"
								aria-hidden="true"> <i class="icon-plus"></i>新建文件夹
							</a> <a type="submit" class="btn"> <i class="icon-arrow-down"></i>离线下载
							</a>
						</div>
				...
				<div id="main-tab-content" class="span12" data-spy="scroll"
					...
					<div class="context-menu" id="main-sys-menu">
						<ul>
							<li id="menu-fold-new"><img src="./image/page_white_add.png" />新建文件夹</li>
							<li id="menu-fold-copy"><img
								src="./image/page_white_copy.png" />复制</li>
							<li id="menu-fold-paste"><img
								src="./image/page_white_copy.png" />粘贴</li>
							<li id="menu-fold-cut"><img src="./image/page_white_cut.png" />剪切</li>
						</ul>
					</div>
